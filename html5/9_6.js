/* Listing 9.6
 * Fetching HTML from the Server and Displaying the Result in the Page
 */
"use strict";
...
var myModule = Object.create({
	...
	if (e.target.nodeName == "H1") {
	    ...
	    xhr.send();
	} else if (e.target.nodeName == "DIV" && e.target.id == "replaceHTML") {
	    var xhr = new XMLHttpRequest();
	    xhr.onreadystatechange = myModule.htmlHandler;
	    xhr.open("GET", "9_7.html"); // "values.html"
	    xhr.send();
	}
    },
