...
// pg#642, Example 21-6. A Koch snowflake with transformations

// Draw a level-n Koch Snowflake fractal on the canvas context c,
// with lower-left corner at (x,y) and slide length len.
function snowflake(c, n, x, y, len) {
    ...
    leg(n);			// Draw the first leg of snowflake
