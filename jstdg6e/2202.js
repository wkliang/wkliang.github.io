...
// pg#670, Example 22-2. A demonstration of all geolocation features
...
function whereami(elt) {
	...
	// The default is 0, which force location to be checked anew.
	...
	// These are fields that we always get. Note that the timestamp
	...
	if (pos.coords.altitude) {
		...
		pos.coords.altitude.Accuracy + "meters above sea level.";
	}
