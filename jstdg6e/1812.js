...
// Issue an HTTP GET request for the contents of specified URL.
...
// Browsers may fire "readstatechange" after abort(), and if a partial
...
function timedGetText(url, timeout, callback) {
	...
	if (request.readState !== 4) return;	// Ignore incomplete requests.
