...
// pg#644, Example 21-7. Adding curves to a path


function draw_curves(c) {
	...
	false);			// false mean clockwise
    c.closePath();		// Add radius back to the center of circle
    ...
    // Use arcTo for rounded corner. Here we draw a square with
    // upper left corner at (400,50) and corners of varying radii.
    c.moveTo(450,50);		// Begin in the middle of top edge.
    c.arcTo(500,50,500,150,30);	// Add part of top edge and upper right corner.
    c.arcTo(500,150,400,150,20);// Add right edge and lower righ corner.
    c.arcTo(400,150,400,50,10);	// Add bottom edge and lower left corner.
    c.arcTo(400,50,500,50,0);	// Add left edget and upper left corner.
    ...
    c.lineWidth = 5;		// 5-pixels black (by default) lines
