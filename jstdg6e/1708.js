 ...
 *
 * To make use of a Keymap, call its install() method, passin an HTML element,
 ...
 *
 * A Kye identifier may also include modifier key prefixes. These prefixes are
 ...
 *
 * Most punctuation characters that do no require the Shift key ('=[];,./\
...
// Bind the specified key identifier to specified handler function
...
Keymap.normalize = function(keyid) {
    ...
    word.push(keyname);				// Add the normalized name back
...
// But the following values seem to work for most browser and OSes.
Keymap.keyCodeToKeyName = {
    ...
    // Letter keys. Note that we don't distiguish upper and lower case
    ...
    // Hyphen is nonportable: FF return same code as Subtract
