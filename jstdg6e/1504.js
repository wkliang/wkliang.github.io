...
function sortrows(table, n, comparator) {
	...
	console.log("row:"+textContent(row1)+":"+textContent(row2));
    ...
    // This is automatically moves them from their current location, so there
    // is no need to remove them first. If the <tbody> contains any nodes
    // other than <tr> element, those nodes will float to the top.
