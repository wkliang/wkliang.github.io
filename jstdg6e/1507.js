 ...
 * and wraps the headings in named anchors so that the TOC can link
 * them. The generated anchors have names that begin with "TOC", so
 * you should avoid this prefix in your own HTML.
 *
 * The entries in generated TOC can be styled with CSS. All entries have
 ...
 *
 * That final line generates a colon and space after section numbers. To
 * hid the section numbers, use this:
 *
...
// onLoad(
TOC_generation =
function() { // Anonymous function defines a local scope
    // Find the TOC container element.
    // If there isn't one, crate one at the start of the document.
	...
	// Add the section number to section header title.
