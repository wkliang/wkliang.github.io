...
// pg#664, Example 21-13. Sparklines with the <canvas> element
/*
 * Find all elements of CSS class "sparkline", parse their content as
 * a series of numbers, and replace it with a graphics representation.
 *
 ...
 * - Sparkline width is from the data-weight attribute if it is defined
 *   or the number of data points times divided by 6
 * - The minimum and maximum values of the y axis are taken from the data-ymin
 *   and data-ymax attributes if the are defined, and otherwise come from
