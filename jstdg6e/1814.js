...
// the URL to specify the name of callback function for the request
function getJSONP(url, callback) {
	...
	url += "?jsonp=" + cbname; // add parameter as query section
    else			   // Otherwise
    ...
    getJSON[cbnum] = function(response) {
	try {
	    callback(response);		// Handle the response data
	}
	finally {
	    delete getJSON[cbnum];	// Delete this function
