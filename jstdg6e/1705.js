...
whenReady(function() {	// Run this function when the document is ready
	...
	// highlights the drop target to let the user knwo of that interest.
	list.ondragenter = function(e) {
	    ...
	    // this where the <ul> element has <li> children. In browsers tat
	...
	// This handler is invoked when drag moves out the list
	...
	function ischild(a, b) {
	    for(; a; a = parentNode) if (a === b) return true;
	    return false;
	}
    }
});
