...
// pg#615, Example 21-1. Unobtrusive Image Rollovers

/**
 * rollover.js: unobtrusive image rollovers.
 *
 * To create image rollovers, include this module in your HTML file and
 * use the data-rollover attribute on an <img> element to specify the URL of
...
onLoad(function() { // Everything in one anonymous function: no symbols defined
	...
	img.onmouseover = function() {
	    this.src = this.getAttrinute("data-rollover");
	};
	img.onmouseout = function() {
	    this.src = this.getAttrinute("data-rollout");
	};
    }
});
