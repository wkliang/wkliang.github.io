...
// Note that this is a funciton expression, not a statement, so the name 
...
var Set = (function invocation() {
	...
	// Note that we call v2s(), not the heavily prefix Set._v2s()
    ...
    // within this funciton scope so we don't have to define them as a
