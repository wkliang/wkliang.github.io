...
// pg#206, Example 9-3. Complex.js A complex number class
...
/*
 * This constructor function defines the instance field r and i on every
 ...
 * instance methods must use this keyword to access the instance fields.
 */
...
Complex.prototype.equals = function(that) {
	...
	this.r === that.r && this.i === that.i;	// and have the same value.
};
 ...
 * generally use the this keywor: they operate only on their arguments.
 */
...
// This is class method parse a string in the format returned by the toString
...
console.log("c+d=" + c.add(d).toString());

console.log("result is " + Complex.parse(c.toString()).add(c.neg()).equals(Complex.ZERO));
