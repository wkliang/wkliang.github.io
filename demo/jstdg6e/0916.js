 ...
 * A singleton set is a read-only set with a single membter.
 */
...
/*
 * AbstractWritableSet is and abstract subclass of AbstractEnumerableSet.
 ...
 * It represents the set elements as an array of values, and use a linear
